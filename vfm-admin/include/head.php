...
$pay = filter_input(INPUT_GET, "indexpay", FILTER_SANITIZE_STRING);
$return = filter_input(INPUT_GET, "return", FILTER_SANITIZE_STRING);
$notify = filter_input(INPUT_GET, 'notifypay', FILTER_SANITIZE_STRING);
$order = filter_input(INPUT_GET, 'order', FILTER_SANITIZE_STRING);
$findusername = filter_input(INPUT_GET, 'findusername', FILTER_SANITIZE_STRING);
