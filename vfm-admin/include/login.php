...
if (!$gateKeeper->isAccessAllowed()) { ?>
    ...
    <section class="vfmblock">
        <div class="login">
            ...
            <div style="color:#aaaaaa; font-style:"><i>*提示：由于系统升级，老用户用户名仍为字母、数字组合，新用户用户名为手机号</i></div>
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <p><a href="?rp=req"><?php echo $encodeExplorer->getString("lost_password"); ?></a> <a href="?findusername">找回用户名</a></p>
                </div>
            </div>
    <?php
