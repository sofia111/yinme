        ...
        <div class="content-wrapper">
            ...
            if (is_array($response)) {
                foreach ($response as $alert) { 
                    $icona = $alert['status'] === 'yep' ? 'fa-check' : 'fa-times';
                    $bgcolor = $alert['status'] === 'yep' ? 'bs-callout-success' : 'bs-callout-danger';
                    ?>
                    <div class="alert bs-callout <?php echo $bgcolor; ?> fade" role="alert">
            ...
            elseif (isset($_GET['shops'])) { 
                ...
                */ 
                ...
                <div class="content body">
                    <div class="row">
                        <?php
                        include "admin-panel/view/shops/new-shop.php";
                        include "admin-panel/view/users/master-admin.php";
                        ?>
                    </div>
                    <?php
                    include "admin-panel/view/shops/list-shops.php";
			...
			elseif (isset($_GET['suggestion'])) { 
                ...
                */ 
                ...
                <div class="content body">
                    <div class="row">
                    <?php
                        include "admin-panel/view/suggestion/suggestion.php";
                ...
                */ 
                ...
                <div class="content body">
                    <div class="row">
                        <?php
                        include "admin-panel/view/orderlist/orderlist.php";
            ...
            elseif (isset($_GET['announce'])) { 
                ...
                */ 
                ...
                <div class="content body">
                    <div class="row">
                    <?php
                        include "admin-panel/view/announce/new-announce.php";
