...
<aside class="main-sidebar">
    <section class="sidebar" id="scrollspy">
        ...
        print "><a href=\"?shops=go\">
        <i class=\"fa fa-users fa-fw\"></i><span>" 
        ."商家".
        "</span></a></li>";
		print "<li";
        if ($activesec == 'orderlist') {
            print " class=\"active\"";
        }
        print "><a href=\"?orderlist=go\">
        <i class=\"fa fa-users fa-fw\"></i><span>" 
        ."订单管理".
        "</span></a></li>";
		
		print "<li";
        if ($activesec == 'suggestion') {
            print " class=\"active\"";
        }
        print "><a href=\"?suggestion=go\">
        <i class=\"fa fa-users fa-fw\"></i><span>" 
        ."意见".
        "</span></a></li>";
        ...
        "</span></a></li>";
        print "<li";
        if ($activesec == 'announce') {
            print " class=\"active\"";
        }
        print "><a href=\"?announce=go\">
        <i class=\"fa fa-users fa-fw\"></i><span>" 
        ." 公告".
        "</span></a></li>";
